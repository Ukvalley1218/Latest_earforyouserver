...
//       return res.status(400).json({
//         success: false,
//         message: "Missing required fields: userId or planId",
//       });
//     }
...
//       merchantUserId: userId,
//       amount: plan.price * 100, // converting to paise
//       redirectUrl: `${process.env.APP_BE_URL}/api/v1/validate/${merchantTransactionId}/${userId}/${planId}`,
//       redirectMode: "REDIRECT",
//       mobileNumber: "9999999999", // Replace or retrieve dynamically
//       paymentInstrument: {
//         type: "PAY_PAGE",
//       },
//     };

//     // Encode the payload and create checksum
//     const bufferObj = Buffer.from(JSON.stringify(phonePePayload), "utf8");
//     const base64EncodedPayload = bufferObj.toString("base64");
...
//     });
//   } catch (error) {
//     console.error("Error in buyPlan with PhonePe:", error);
//     return res.status(500).json({
//       success: false,
//       message: "Failed to initiate payment for plan purchase",
//     });
//   }
// };
...
//     return res.status(400).json({
//       success: false,
//       message: "Missing required fields: merchantTransactionId, userId, or planId",
//     });
//   }
...
//       // Deduction and plan update
//       wallet.planId = plan._id;
//       wallet.deductions.push({
//         amount: plan.price,
//         deductionReason: "plan_purchase",
...
//         `Successfully purchased plan for ₹${plan.price}.`
//       );
